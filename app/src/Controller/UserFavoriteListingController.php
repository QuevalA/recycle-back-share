...
#[Route('/userFavoriteListing')]
class UserFavoriteListingController extends AbstractController
{
    ...
    #[Route('/byUser/{id}', name: 'app_userFavoriteListing_show_by_user', methods: ['GET'])]
    public function getByUser($id, UserFavoriteListingRepository $userFavoriteListingRepository): JsonResponse
    {
        //listingStatus 1 = "Publiée", as there's no need to show a user his faved listings if they are no longer available.
        $userFavoriteListings = $userFavoriteListingRepository->findByUserAndListingStatus($id, 1);
